...
/**********************************************************************************//**
	...
	@details	ID:スタック-1\n
				...
				要素数が1であれば成功です。\n
*//***********************************************************************************/
TEST(TestGetSize, WhenAfterPush) {
	Stack<int> stack;
	stack.Push(0);
...
/**********************************************************************************//**
	...
	@details	ID:スタック-4\n
				...
				要素数が2であれば成功です。\n
*//***********************************************************************************/
TEST(TestGetSize, WhenAfterPushTwice) {
	Stack<int> stack;
	stack.Push(0);
	stack.Push(0);
...
*//***********************************************************************************/
TEST(TestPush, WhenStackHasMultipleData) {
	Stack<int> stack;
...
*//***********************************************************************************/
TEST(TestPop, PopOnceWhenStackHasMultipleData) {
	Stack<int> stack;
	const int dataNum = 4;
...
/**********************************************************************************//**
	...
	@details	ID:スタック-13\n
				...
				戻り値がtrueであり、要素数が1減っていると成功です。\n
*//***********************************************************************************/
TEST(TestPop, WhenStackHasMultipleData) {
	Stack<int> stack;
	const int dataNum = 4;
